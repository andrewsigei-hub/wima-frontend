import { Flower2, Coffee, Users, Handshake } from "lucide-react";

const About = () => {
  const features = [
    { icon: Flower2, label: "Tropical Gardens" },
    { icon: Coffee, label: "Tea Country Views" },
    { icon: Users, label: "Family Owned" },
    { icon: Handshake, label: "Warm Service" },
  ];

  return (
    <section id="about" className="py-20 bg-green-mist/40">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="font-display text-3xl md:text-4xl text-botanical mb-6">
            A Place of{" "}
            <span className="font-script text-4xl text-heritage-gold">
              Peace & Beauty
            </span>
          </h2>
          <p className="text-slate-700 max-w-2xl mx-auto leading-relaxed">
            Since 2017, WIMA Serenity Gardens has been a haven for travelers
            seeking rest and connection with nature. Our family-run guest house
            combines the warmth of Kenyan hospitality with the serene beauty of
            Kericho's highlands.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="lg:pl-8 lg:pt-8">
            <p className="text-slate-700 leading-relaxed mb-8">
              Whether you're here for a peaceful getaway, a family reunion, or a
              memorable celebration, our gardens and comfortable rooms provide
