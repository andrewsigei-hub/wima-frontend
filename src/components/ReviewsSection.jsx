        ...
        <div className="bg-white rounded-2xl border border-heritage-gold-soft/40 shadow-lg p-6 md:p-8">
          {isConfigured ? (
            <ReactGoogleReviews
              ...
              carouselBtnClassName="!border !border-heritage-gold-soft/70 !bg-cream-bg !text-botanical hover:!bg-cream-light"
              carouselBtnLeftClassName="!left-0 md:!left-2"
              carouselBtnRightClassName="!right-0 md:!right-2"
              reviewCardClassName="!rounded-2xl !border !border-heritage-gold-soft/40 !shadow-md !bg-cream-bg"
