  ...
  const contactMethods = [
    {
      icon: Phone,
      label: "Call Us",
      values: ["+254 700 000 000", "+254 711 000 000"],
    },
    {
      icon: MessageCircle,
      label: "WhatsApp",
      values: ["Chat on WhatsApp"],
      link: "https://wa.me/254700000000",
    },
    {
      icon: Mail,
      label: "Email Us",
      values: ["info@wimaserenity.com", "bookings@wimaserenity.com"],
    },
    {
      icon: Clock,
      label: "Business Hours",
      values: ["Mon - Sun: 7:00 AM - 9:00 PM"],
      note: "Guest check-in: 24/7",
    },
  ];
            ...
            {contactMethods.map((method, index) => {
              ...
              return (
                ...
                >
                  ...
                  {method.note && (
                    <p className="text-xs text-slate-500 italic mt-2 bg-accent/50 px-3 py-1 rounded-full inline-block">
                      {method.note}
                    </p>
                  )}
                </div>
