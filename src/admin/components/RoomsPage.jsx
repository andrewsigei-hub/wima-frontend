          ...
          <div>
            ...
            <div className="flex gap-2 mb-2">
              ...
              <button
                type="button"
                onClick={addAmenity}
                className="px-3 py-2 rounded-lg bg-botanical/10 text-primary text-sm font-medium hover:bg-botanical/20 transition-all shrink-0"
              >
                Add
              </button>
            </div>
